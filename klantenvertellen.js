/**
 * Klantenvertellen signup link builder.
 *
 * Lazy route: we don't provision the account ourselves. After payment
 * we just send the customer to https://klantenvertellen.nl/signup with their
 * details prefilled via query string, and they finish the form.
 *
 * Configure via config.klantenvertellen.json (or env):
 *   kvSignupUrl  defaults to "https://klantenvertellen.nl/signup"
 */

const DEFAULT_SIGNUP_URL = 'https://klantenvertellen.nl/signup';
...
/**
 * Build a klantenvertellen.nl/signup URL with the customer's data prefilled as
